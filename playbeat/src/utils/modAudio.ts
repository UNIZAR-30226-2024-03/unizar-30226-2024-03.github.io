 ...
 */
async function modAudio(data: {titulo?: string;esPrivada?: boolean,img?: string,esAlbum?: boolean,fechaLanz?: any,duracionSeg?: number,cancion?: any, esPodcast?:any, etiquetas?: string, tipoEtiqueta?: string}, token: any, id?:string) {
